...
const HomePage = ({ onNavigate, darkMode }) => {
  return (
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ flex: '1', minWidth: '300px' }}>
          ...
          <h1 style={{
            ...
            marginBottom: '24px',
            background: darkMode
              ? 'linear-gradient(135deg, #fff, hsl(var(--primary)))'
              : 'none', // No background for light mode
            color: darkMode ? 'transparent' : 'hsl(var(--primary-dark))', // Solid color for light mode
            WebkitBackgroundClip: darkMode ? 'text' : 'border-box',
            WebkitTextFillColor: darkMode ? 'transparent' : 'hsl(var(--primary-dark))'
          }}>
